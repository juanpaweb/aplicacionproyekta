...
$test = new attach_mailer($name = "Olaf Lederer", $from = "me@mymail.com", $to = "you@gmail.com", $cc = "copy@provider.org", $bcc = "blind@copy.org", $subject = "Test mime email class", $body = "Some body text");
